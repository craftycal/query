...
<br>
          <?php if( isset($loginMessage) ): ?>
            <p><span class="glyphicon glyphicon-info-sign"></span> <?= $loginMessage ?> </p>
          <?php endif ?>
        <div class="input-group">
          <input type="submit" name="loginForm" value="submit" class="btn btn-default" aria-describedby="basic-addon1">
        </div>
      </form>
